        ...
        <div className="tb-inner">
          ...
          <div className="tb-right" style={{ gap: 20, alignItems: "center" }}>
            <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
              <NavLink to="/student/notifications" className={({ isActive }) => (isActive ? "active" : "")} style={{ color: "var(--green-900)", textDecoration: "none", display: "flex", alignItems: "center", position: "relative" }} title="Alerts">
                ...
                {unreadCount > 0 && (
                  <span style={{
                    ...
                    fontSize: "0.65rem", fontWeight: "bold", width: 14, height: 14, display: "flex", alignItems: "center", justifyContent: "center", borderRadius: "50%", lineHeight: 1, border: "2px solid #fff"
                  }}>
                    {unreadCount}
                  </span>
                )}
